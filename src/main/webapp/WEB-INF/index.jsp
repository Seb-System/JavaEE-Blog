...
<body>
	...
	<main role="main">
		...
		<div class="jumbotron">
			<div class="container">
				<h1 class="display-3">Ynov Paris - Blog</h1>
				<p>Blog crée en JavaEE par Sébastien Erve avec l'aide de Romain
					Sessa à Ynov Paris Campus</p>
				<p>
					<a class="btn btn-primary btn-lg" href="#" role="button">Plus
						d'info &raquo;</a>
				</p>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<h2>
						<%
							String title1 = (String) request.getAttribute("title-1");
							out.println(title1);
						%>
					</h2>
					<p>
						<%
							String text1 = (String) request.getAttribute("text-1");
							out.println(text1);
						%>
					</p>
					<a class="btn btn-secondary" href="listArticles" role="button">View
						details &raquo;</a>
					</p>
				</div>
				<div class="col-md-4">
					<h2>
						<%
							String title2 = (String) request.getAttribute("title-2");
							out.println(title2);
						%>
					</h2>
					<p>
						<%
							String text2 = (String) request.getAttribute("text-2");
							out.println(text2);
						%>
					</p>
					<p>
	...
	<script>
		window.jQuery
				|| document
						.write('<script src="https://getbootstrap.com/docs/4.4/assets/js/vendor/jquery.slim.min.js"><\/script>')
	</script>
	<script
