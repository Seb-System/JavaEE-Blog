...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1 class="jumbotron-heading">Listes des articles</h1>
										...
										<div class="btn-group">
											...
											<input type="hidden" name="id" value="${ article.id }">
												<a class="btn btn-sm btn-outline-success"
													href="viewArticle?id=${ article.id }" name="button">Voir</a>
												<a class="btn btn-sm btn-outline-warning"
													href="editArticle?id=${ article.id }" name="button">Editer</a>
												<input type="submit" class="btn btn-sm btn-outline-danger"
													name="button" value="Supprimer" />
											</form>
										</div>
